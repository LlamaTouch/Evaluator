...
class TestCheckImgMatch(unittest.TestCase):
    def setUp(self):
        ...
        self.test_data = [
            # """small size of EXACT"""
            {   
                "annotated_ui_node": json.load(open(self.case_json[0], "r", encoding="utf-8"))[0],
            ...
            {
                "annotated_ui_node": json.load(open(self.case_json[1], "r", encoding="utf-8"))[16],
            ...
            # """large size of EXACT"""
            {
                "annotated_ui_node": json.load(open(self.case_json[2], "r", encoding="utf-8"))[22],
    ...
    def test_check_img_match(self):
        for test_case in self.test_data:
                with self.subTest(test_case=test_case):
                    ...
                    result = _check_img_exact_match(annotated_ui_node,gr_screenshot_path, exec_screenshot_path, bound)
